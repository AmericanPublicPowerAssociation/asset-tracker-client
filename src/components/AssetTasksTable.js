...
const rows = [
  ...
  const headRows = [
    { id: 'name', numeric: false, disablePadding: true, label: 'Time' },
    { id: 'calories', numeric: true, disablePadding: false, label: 'Name' },
    { id: 'fat', numeric: true, disablePadding: false, label: 'Assigned Person' },
    { id: 'carbs', numeric: true, disablePadding: false, label: 'Asset Name' },
